...
test('index.html uses studio185 cache buster and includes recharge checkout structure', () => {
  assert.match(html, /style\.css\?v=studio185/, 'CSS must be tagged with studio185');
  assert.match(html, /app\.js\?v=studio185/, 'app.js must be tagged with studio185');
  assert.match(html, /runtime-panel\.js\?v=studio185/);
  assert.match(html, /appearance\.js\?v=studio185/);
