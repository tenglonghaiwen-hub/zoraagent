...
开始写作前读取 [official-rules.md](references/official-rules.md) 和 [capability-map.md](references/capability-map.md)，先确定模型边界和能力路径。H3 模型与 API 限制属于高频变化信息；涉及 API 提交、参数限制或当前日期晚于规则文件更新时间时，先核对规则文件列出的官方来源。
