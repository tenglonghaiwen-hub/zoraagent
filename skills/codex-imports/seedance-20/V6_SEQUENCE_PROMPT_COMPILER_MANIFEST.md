...
- Current expected eval cases: 122.
...
Final full-suite run on 2026-06-29 (v6.3.0 audio-research release):

- `python scripts/validate_skills.py --strict`: pass; root plus 28 sub-skills and required v6.3.0 files.
- `python scripts/content_audit.py --strict`: pass; active content clean, migrated archived warnings remain warning-only.
- `python scripts/eval_schema_check.py --strict`: pass; 122 eval cases.
