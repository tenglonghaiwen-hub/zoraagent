<!-- AUTO-TRANSLATED: 源文件 = ../../../../references/migrated/v5.2-legacy-skill-bodies/seedance-vocab-ko.md ; 最后同步 = 2026-07-06 -->
<!-- 校对状态: draft -->
...
使用本技能获取韩语 Seedance 2.0 提示词措辞与电影词汇。保持活动技能指引精简；扩展的旧版术语列表已迁移到 `references/migrated/seedance-vocab-ko-original.md`。
