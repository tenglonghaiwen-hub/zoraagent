<!-- AUTO-TRANSLATED: 源文件 = ../../../../references/migrated/v5.2-legacy-skill-bodies/seedance-vocab-es.md ; 最后同步 = 2026-07-06 -->
<!-- 校对状态: draft -->
...
使用本技能获取西班牙语 Seedance 2.0 提示词措辞与电影词汇。保持活动技能指引精简；扩展的旧版术语列表已迁移到 `references/migrated/seedance-vocab-es-original.md`。

规则：
- 翻译制作意图，而非逐字英文填充词。
- 精确保留参考标签：`[Image1]`、`[Video1]`、`[Audio1]`。
- 在风格形容词之前优先保留具体名词、动作动词、摄影机运动、光源与声音提示。