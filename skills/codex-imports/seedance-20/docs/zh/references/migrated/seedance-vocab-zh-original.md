<!-- AUTO-TRANSLATED: 源文件 = ../../../references/migrated/seedance-vocab-zh-original.md ; 最后同步 = 2026-07-06 -->
<!-- 校对状态: draft -->
<!-- 术语表: references/vocab/zh.md -->
<!-- 备注: 源文件已为中文，仅翻译元数据部分 -->

# `seedance-vocab-zh` 的旧版体
...
中文提示词相较于英语等价词提供 2–3 倍更高的语义密度。
直接在提示词中使用这些术语，或与英文组合以获得混合精度。
