...
export function selectH3(input){
 ...
 if(mode==='ref'&&images.length>0&&images.length<3)return fail('H3 OpenAI 格式会将1–2张图片识别为首尾帧，不能作为多模态参考提交；请提供至少3张实际参考图，或仅使用视频/音频参考');
 const apiRoute='/v1/videos';
 ...
 return {ok:true,mode,selected:{operation,apiRoute},queryRoute:'/v1/videos/{task_id}'};
}
